...
public class MyActivity extends Activity   {
  ...
  private void updateWeatherOnScreen(Location location) {
    ...
    if (locationServiceURL!=null) {
      new GetWeatherAsync(this).execute(locationServiceURL);
    }
    else {
  ...
  private Location getLastKnownLocation() {
    ...
    //Another way of getting a location
    //iterate the providers to get the best location
    //
    //if (result==null) {
    ...
    //      continue;
    //    }
    //    if (result == null || l.getAccuracy() < result.getAccuracy()) {
